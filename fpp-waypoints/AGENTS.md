# AGENTS.md - fpp-waypoints

Owns waypoint and patrol behavior.

Keep here:
- `FppWaypointsExtension`
- `WaypointStore`
- `PatrolManager`
- waypoint commands and storage
- patrol routes and waypoint GUI/settings

Core persistence can expose neutral task hooks, but waypoint stores and patrol command behavior belong in this extension.
